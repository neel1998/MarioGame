'''drawing background module'''
from make_stairs import make_stairs
from draw_castle import draw_castle


def print_background(self):
    '''printing background function'''
    # init(autoreset=True)
    level1 = self.level1
    for i in range(40):
        for j in range(1000):
        ...
        for i in range(1, 150 * 5, 150):
            for j in range(20, 150, 30):
                if j == 20:
                    ...
                    temp = 10
                level1[temp][i + j + 3] = '\033[94m' + "_" + '\033[0m'
                level1[temp + 1][i + j + 1] = '\033[94m' + "_" + '\033[0m'
                level1[temp + 1][i + j + 2] = '\033[94m' + "(" + '\033[0m'
                level1[temp + 1][i + j + 4] = '\033[94m' + ")" + '\033[0m'
                level1[temp + 2][i + j] = '\033[94m' + "(" + '\033[0m'
                level1[temp + 2][i + j + 1] = '\033[94m' + "_" + '\033[0m'
                level1[temp + 2][i + j + 2] = '\033[94m' + "_" + '\033[0m'
                level1[temp + 2][i + j + 3] = '\033[94m' + "_" + '\033[0m'
                level1[temp + 2][i + j + 4] = '\033[94m' + "_" + '\033[0m'
                level1[temp + 2][i + j + 5] = '\033[94m' + ")" + '\033[0m'
        # float
        for i in range(self.flyer.posx, self.flyer.posx + 10, 1):
            level1[self.flyer.posy][i] = "X"
        # Stairs
